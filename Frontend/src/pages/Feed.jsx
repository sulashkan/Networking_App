...
export const Feed = () => {
  ...
  console.log("data", user);
   ...
   if(loading) return <div className="w-full min-h-screen text-3xl justify-center items-center">Loading</div>;
  ...
  return (
    <div className="bg-gray-200 min-h-screen   w-full " >
     ...
     <div className="relative"> <img className="w-full h-150" src="https://files.123freevectors.com/wp-content/resized/27628-light-blue-wave-background-design.jpg"></img></div>
  
      <div className="absolute bottom-40 left-110 flex justify-center  grid-cols-4  gap-3">
        <div className="flex justify-center items-center ml-1 card bg-base-100 w-96 shadow-sm bg-blue-950 mt-8 hover:transition-shadow">
     ...
     <div className=" w-full  absolute p-1 bottom-0  mt-25"> <Footer/></div>
    </div>
  );
};
