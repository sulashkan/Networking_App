...
export const ProfileDetails = ({ prof }) => {
  ...
  if (!prof) return <p className="text-white">Loading...</p>;
  ...
  return (
    <div className=" w-full flex justify-center items-center">
      <div className="relative  flex ml-1 card  w-120 shadow-sm bg-gray-800  mt-8 hover:transition-shadow">
        <div className=" flex flex-col">
          ...
          <p className="px-10 pt-10 text-red-300 ml-25"> ID:- {prof._id}</p>
        </div>
            ...
            <div>
              <div className="flex flex-col items-start">
                ...
                <input
                  text="text"
                  value={form.name}
                  className="text-white border p-1 rounded w-"
          ...
          <div className="flex gap-1">
           ...
           <div className="flex gap-3">
              <button
                ...
                className=" hover:bg-green-600  p-2 bg-green-400 text-black rounded-md"
              >
                {edit ? "Update" : "Edit"}
              </button>
              <button
                onClick={deleteHandler}
                className=" hover:bg-red-600  p-2 bg-red-400 text-black rounded-md"
              >
                Delete
              </button>
            </div>
