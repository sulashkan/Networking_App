...
export const ProfileDetails = ({ prof }) => {
  ...
  return (
    <div className="w-full flex justify-center items-center">
      {/* {prof.map((user) => ( */}
      <div className="flex ml-1 card bg-base-100 w-120 shadow-sm bg-gray-800  mt-8 hover:transition-shadow">
        <div className="flex flex-col">
          <button
            onClick={updateHandler}
            className=" hover:bg-green-600 ml-100 mr-2 mt-5 p-2 bg-green-400 text-black rounded-md"
          >
            {edit ? "Update" : "Edit"}
          </button>
